export default {
  ...
  features: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ƛ¬Ð@ĞÆÒªǱ'], encodeOffsets: [[9810, 48188]] }, properties: { name: 'Liechtenstein', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
        coordinates: [
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@Π˗ä̋ÝԍȄ́ɊßQÙÚŷűŻȉ̍ǝ©¡aquwW@yÐğBƧůÙPÑXkAűˬѽ̨ŚAĹɐȨࠐDŮȡæ½ʮ̾ϦŒŷɴÒ'], encodeOffsets: [[20546, 43569]] },
      properties: { name: 'Albania', childNum: 1 },
    },
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@Ł^ĊĤ³'], ['@@ɨ÷ϫƯħƾƊ¡sƜƖ']], encodeOffsets: [[[20135, 61632]], [[20470, 61800]]] },
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@́{ř̮ǯŔfƖ˟§ʭôķƶɛ½Г˲Իðą̘ŸȦʁ͚՚Ú؞ÞǆǀťıÑѢȓǫƣÜşєʣßǫʳ¡Ժ͏ɼīŷȀƭƹúʇ'], encodeOffsets: [[47607, 39841]] },
      properties: { name: 'Armenia', childNum: 1 },
    },
    { geometry: { type: 'Polygon', coordinates: ['@@āɆƃë'], encodeOffsets: [[-174823, -14695]] }, properties: { name: 'American Samoa', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ťowîÐÒĎŏ'], encodeOffsets: [[-63197, 17446]] }, properties: { name: 'Antigua and Barb.', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ÛĝƄHɜĬXl̛'], encodeOffsets: [[51822, 26505]] }, properties: { name: 'Bahrain', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@ÝŝĔɜuĽ'], ['@@˵CÒྪzƀ˞KʄИȒv­ħȀOĿƽԭÌÿğݑӥد']], encodeOffsets: [[[-89961, 17841]], [[-91027, 16272]]] },
      properties: { name: 'Belize', childNum: 2 },
    },
    { geometry: { type: 'Polygon', coordinates: ['@@ŏgǎĞ½õ'], encodeOffsets: [[-66283, 33069]] }, properties: { name: 'Bermuda', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ıjǜȂųÇÑ'], encodeOffsets: [[-60921, 13396]] }, properties: { name: 'Barbados', childNum: 1 } },
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@Ĩ@ŴҟƷãє'], ['@@ɽƳĀ˙ƽ̗ӷҰ̢ÌӒ̤Ĺ']], encodeOffsets: [[[117788, 5018]], [[117788, 5018]]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ȳèƍȨ΂ˏ'], encodeOffsets: [[-70401, 12350]] }, properties: { name: 'Curaçao', childNum: 1 } },
    {
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ѹÃýƌϵÙǧìƖRÀǮ֔ߖʶԩ̳Àȑ'], encodeOffsets: [[34821, 35907]] }, properties: { name: 'N. Cyprus', childNum: 1 } },
    { geometry: { type: 'Polygon', coordinates: ['@@Ǩë϶ÚþƋѺÄÛ̍eׇͳҹƆōȌ_ňΊö'], encodeOffsets: [[33498, 36016]] }, properties: { name: 'Cyprus', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ÿké΀ƴęIɹ'], encodeOffsets: [[-62752, 15615]] }, properties: { name: 'Dominica', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@ċøǜǜk~ĤŊ״ÆٖɳȦǼ̹юw̻Åcõ߂ǳ̄ʗ̇ͫȻǊ˷зH׫ȏƑĴ͏ÁΉՙǉŜŗɠHƐxÊsÐġÚÉĄ»ð\\XĶHļĴbÐM¬ÕŌƈǬ'], encodeOffsets: [[-73366, 19657]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@@ƢĞĝǯ'], encodeOffsets: [[-63196, 12301]] }, properties: { name: 'Grenada', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ýƚȐƾÆǗʻ'], encodeOffsets: [[148216, 13578]] }, properties: { name: 'Guam', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@̽ĥ̤ˬZȅ'], encodeOffsets: [[-4517, 55486]] }, properties: { name: 'Isle of Man', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@ǷÿGkcȋÉNå¤açjģlŅ×¯Ĺ¯ƫȹWqsPclMÐlØkÜÉɅŭÏȟӐĤБྣÍßփบĒìDÐƨƎ£¸NPǎʮβীʬOϨ̚ЛŁǷ'], encodeOffsets: [[36647, 33521]] },
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@ůįYӱŭɛÇԱŽɹÍɍÃ࡬࠯į³ǋāgcacãƗ¿őka׵Ň©ĥƑīƟǋŝǵŻऱŸnǞВྤĸْiƂdȌHlǸĀӬ̇ϒÏ࿦ࢲɤࣉǦěŭĳ'], encodeOffsets: [[40085, 32896]] },
    ...
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@ƔĭͷƌŤ¯ÒĊÝâĶ³iĥ'], ['@@ÄŃőÞÎ¦']], encodeOffsets: [[[-161118, 1901]], [[-163163, 4018]]] },
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@àūìЭɛίʨƟʲĀ§òǑÒĳĀWƴÇ°ʓƻՑV˿|ȅ׵Ȫܻ϶१ࡰ࡝ԢǹȀȪ˜͞ʲȘȄÞʾ®°ƂÀÜʠ¨Hðê÷ʂĜɜǇŰգÿʍ̄ǗȒȘΨƢŉ'], encodeOffsets: [[-8690, 7740]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@³ĕķŰƒȒZɫ'], encodeOffsets: [[-62356, 14154]] }, properties: { name: 'Saint Lucia', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@Ϡʉ֢˯ʑÉTǳɳÑőŸ̽ϥ¾ʭݿ׈ĠæáŖmǈb|z^Ŕ`CĆ¬ĚÚ¬ĐÀìM­¢NTÄąŞV~p`®Sª]TªP|Crë'], encodeOffsets: [[19680, 44493]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@èĞ¦Ïō'], encodeOffsets: [[149250, 15497]] }, properties: { name: 'N. Mariana Is.', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@Ó~ĖÁ'], encodeOffsets: [[-63640, 17143]] }, properties: { name: 'Montserrat', childNum: 1 } },
    { geometry: { type: 'Polygon', coordinates: ['@@˩¶ĈȲȮǎŔȇşɭ'], encodeOffsets: [[59035, -20976]] }, properties: { name: 'Mauritius', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ũVĪĚį'], encodeOffsets: [[-173878, -19541]] }, properties: { name: 'Niue', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
    ...
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@ūɸGŋw'], ['@@тÁPś̍ɥ਍jÉ̶ĘŔࡼ¯']], encodeOffsets: [[[-66995, 18541]], [[-67716, 18888]]] },
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@aM¡Ýľƅà{ª½¨ĕÂӣkĹuÕÇ¡PµSÁoEŧòʓēƿÞ¿̓ƛßʵ]ʍǴóĽĵîcȢɊǤÆЌ͊˨Ⱦ¬Ėœΰͪ¬X¶EA'], encodeOffsets: [[31243, -1092]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ˍKƘĸŶī'], encodeOffsets: [[106465, 1364]] }, properties: { name: 'Singapore', childNum: 1 } },
    {
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ùMÚĊ`û'], encodeOffsets: [[-5828, -16381]] }, properties: { name: 'Saint Helena', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    {
      geometry: { type: 'Polygon', coordinates: ['@@]œƃÿƿŷįWƍ̩É˅Ƕ߱sſș͏ů˙Ü۫ȇÉǳ߱cԫȤɿ͌òǲƶȰԼ ˞ƪÚǊ֠Ɉˈģʘǖ˨ȍcƗʨoʲǢьÏǰĔҺM͌ǝϠŅÆQ'], encodeOffsets: [[23080, 50251]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@DýƅƪÔ¦îő'], encodeOffsets: [[56874, -4805]] }, properties: { name: 'Seychelles', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ǂ·ǇFþ'], encodeOffsets: [[-74068, 22376]] }, properties: { name: 'Turks and Caicos Is.', childNum: 1 } },
    {
      geometry: {
        type: 'Polygon',
    ...
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@êßőǥƀǜ¿'], ['@@īAĎÚ^×']], encodeOffsets: [[[-179365, -21677]], [[-178128, -19086]]] },
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@ÿŊňÒǛ'], encodeOffsets: [[-62642, 13474]] }, properties: { name: 'St. Vin. and Gren.', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    { geometry: { type: 'Polygon', coordinates: ['@@Ƽʷ£ļþ'], encodeOffsets: [[-66320, 18222]] }, properties: { name: 'U.S. Virgin Is.', childNum: 1 } },
    {
      geometry: {
        type: 'MultiPolygon',
        coordinates: [
    ...
    {
      geometry: { type: 'MultiPolygon', coordinates: [['@@ϧœŨϊmŲƕ'], ['@@ƀȁ¡ĳʻZȱɲϐª']], encodeOffsets: [[[-175569, -14383]], [[-176469, -13788]]] },
