<template>
    <div class="w-full relative z-20 flex flex-col pt-[90px] md:h-screen min-h-[670px] flex-shrink-0">
        <Bg />
        <div class="relative max-w-[1340px] mx-auto justify-center flex w-full md:flex-1 px-5 flex-shrink-0">
            <div class="flex flex-1 flex-col justify-center items-center">
                <h1
                    class="text-[48px] mt-[70px] md:text-[58px] leading-[58px] w-full text-center md:w-[50%] xl:text-[68px] font-bold xl:leading-[84px] text-[#fff]">
                    Earn rewards while securing EMC
                </h1>
                <p
                    class="mt-[40px] md:mt-[50px] text-[18px] md:text-[20px] w-full md:w-[50%] text-center leading-[30px] text-white/70">
                    Unlock the
                    power of your
                    EMC
                    tokens and
