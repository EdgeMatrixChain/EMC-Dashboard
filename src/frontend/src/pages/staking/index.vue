            ...
            <div class="max-w-[1340px] mx-auto flex w-full flex-1 px-5 lg:mt-[50px] mt-[40px] flex-shrink-0">
                <div
                    ...
                    <div class="flex mt-[10px] lg:mt-0 flex-col justify-center lg:pr-[80px] relative">
                        <div class="flex flex-col w-[calc(100%-30px)] lg:w-[calc(100%-80px)] flex-1 lg:py-[33px] py-[25px]
                        lg:px-[40px] px-[18px] ml-[15px] lg:ml-auto flex-shrink-0 rounded-[16px] border-[2px]
                        border-[#fff]/20">
                            ...
                            <div class="flex justify-between lg:mb-[35px] mb-[20px] lg:justify-start">
                                <p class="text-[15px] lg:text-[18px] text-white/70 font-medium leading-[18px]">Reward
                                    Earnings:</p>
                                <p class="text-[15px] lg:text-[18px] text-white font-medium leading-[18px] ml-auto">
                                    {{ rewardEarnings }} EMC
                                </p>
                            ...
                            <div class="flex justify-between lg:mb-[35px] mb-[20px] lg:justify-start">
                                <p class="text-[15px] lg:text-[18px] text-white/70 font-medium leading-[18px]">Start Time:
                                </p>
                                <p class="text-[15px] lg:text-[18px] text-white font-medium leading-[18px] ml-auto">
                        ...
                        <div v-if="useETHUser.account0"
                            class="w-[calc(100%-30px)] ml-[15px] items-center lg:ml-auto mt-[30px] justify-between lg:justify-center flex">
                            ...
                            <div class="bg-[#323557] cursor-pointer rounded-[8px] flex justify-center items-center text-[16px] font-medium w-[136px] lg:w-[240px] h-[44px]"
                                @click="onWithdraw">
                                Withdraw
                            </div>
                        </div>
                    ...
                    <div v-if="tradingList.length > 0"
                        ...
                        <div
                            ...
                            <div
                                class="flex flex-col pb-[4px] px-[10px] lg:px-[30px] w-full pt-[19px] h-[245px] overflow-y-scroll">
                                <div v-for="item in tradingList" :key="item._id" class="flex mb-[26px]">
                                    ...
                                    <p class="text-[12px] lg:text-[16px] font-medium leading-[16px] flex flex-1">{{
                                        item.staked }}</p>
                                    <p class="text-[12px] lg:text-[16px] font-medium leading-[16px] flex flex-[0.7]">{{
                                        item.nAPR }}</p>
                                </div>
                            </div>
                        </div>
