<template>
  <div class="page">
    <div style="max-width: 640px; margin: auto">
      ...
      <template v-else>
        <Form :sale-contract="saleContract" :token-contract="tokenContract" :fund-contract="fundContract" :cliffs-contract="cliffsContract" />
      </template>
    </div>
  </div>
</template>
...
import { NSpace, NCard, NText, NButton, NSpin, useMessage } from 'naive-ui';
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      saleContract.value = networkConfig.smarts.publicSell.contract;
      init();
    });
