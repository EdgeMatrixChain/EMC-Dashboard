      ...
      <div class="flex flex-col px-[50px] items-center relative bg-[#1A1C34] rounded-[24px]">
        ...
        <div class="mt-[50px] md:w-[105px] w-[70px] md:h-[105px] h-[70px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 105 105" fill="none">
            ...
            />
            <defs>
              <linearGradient id="paint0_linear_462_14781" x1="0" y1="0" x2="100.263" y2="105" gradientUnits="userSpaceOnUse">
        ...
        <p class="mt-[20px] mb-[50px] text-center flex text-[14px] leading-[20px] text-[#fff]/70 font-medium">You have successfully staked your EMC</p>
      </div>
    </n-card>
  </n-modal>
</template>
