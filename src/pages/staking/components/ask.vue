<template>
    <div class="w-full flex flex-col md:pt-[90px] pt-[30px] flex-shrink-0 pb-[54px] md:pb-[300px] relative z-10">
        ...
        <div
            class="max-w-[742px] flex-col mx-auto flex w-full flex-1 md:px-5 px-[15px] mt-[20px] md:mt-[50px] flex-shrink-0">

            <div
                class="flex flex-col duration-300 md:mb-[40px] mb-[20px] border-linear w-full overflow-hidden rounded-[10px]">
                <div
